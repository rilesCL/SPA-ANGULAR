...
Vous devrez créer une page de profilé permettant à votre utilisateur de voir ces informations lorsqu'une session est établie. Ici vous devez sécuriser votre API pour permettre uniquement à l'utilisateur de voir ses informations.
...
Votre application doit contenir un bouton permettant de démarrer une tâche. Cliquer sur ce bouton débutera la mesure de temps passé sur l'activité.
  ...
  - Vous devez transmettre l'information sur le serveur qui mesurera le temps de l'activité. Ici ce n'est pas votre application qui calcule le temps.
  - Votre application doit afficher le temps écoulé sur une activité en cours
  - Si votre application est redémarrée et qu'une activité est en cours, vous devez récupérer l'information sur l'activité et remettre en place le compteur.

#### Bouton "Terminer une tâche"

Lorsqu'une tâche est en cours, le bouton pour démarrer une tâche est remplacé par ce bouton. Ceci permet:

- Terminer une capture
  - Un bouton pour terminer une capture doit être disponible lorsqu'une activité est en cours. 
  - Cliquer sur terminer doit transmettre au serveur une fin pour l'activité
